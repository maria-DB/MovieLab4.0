...
const Edit = ({id,movie}) => {
    ...
    useEffect(() => {
        ...
        setValues({
            ...
            year: movie.year,
            date_released: new Date(movie.date_released),
            plot: movie.plot,
            actors: movie.members.filter((member) => (member.role === 'Actor' || member.role === 'Actress')),
            producers: movie.members.filter((member) => (member.role === 'Producer')),
            gross: movie.gross,
        })
